...
class FundFlowHandler(BaseHTTPRequestHandler):
    ...
    def login(self, method: str) -> None:
        ...
        <div class="auth-card">
            ...
            <form method="post">
                <label>Email</label><input name="email" type="email" required placeholder="admin@fundflow.local">
                <label>Mot de passe</label><input name="password" type="password" required placeholder="admin123">
            ...
            <div class="notice" style="margin-top:16px"><strong>Compte admin:</strong><br>admin@fundflow.local / admin123</div>
        </div>
        """
